...
@implementation DCWKWebViewJavascriptBridge {
...
+ (void)enableLogging { [DCWebViewJavascriptBridgeBase enableLogging]; }

+ (instancetype)bridgeForWebView:(WKWebView*)webView {
    DCWKWebViewJavascriptBridge* bridge = [[self alloc] init];
